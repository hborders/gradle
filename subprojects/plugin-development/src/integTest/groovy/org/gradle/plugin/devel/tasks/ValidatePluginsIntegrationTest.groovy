...
import static org.gradle.integtests.fixtures.executer.DocumentationUtils.*
...
class ValidatePluginsIntegrationTest extends AbstractPluginValidationIntegrationSpec {
    ...
    def "detects missing DisableCachingByDefault annotations"() {
        ...
        expect:
        assertValidationFailsWith([
            error(normalizeDocumentationLink("""Type 'MyTask' must be annotated either with @CacheableTask or with @DisableCachingByDefault.
...
Please refer to https://docs.gradle.org/current/userguide/validation_problems.html#disable_caching_by_default for more details about this problem.""")),
            error(normalizeDocumentationLink("""Type 'MyTransformAction' must be annotated either with @CacheableTransform or with @DisableCachingByDefault.
